...
from khrylib.rl.agents import AgentrPPO
from khrylib.rl.core import estimate_advantages, LoggerRL
from torch.utils.tensorboard import SummaryWriter
from transit.envs import TransitEnv
from transit.models.model import create_RL_model, create_GAGRL_model, ActorCritic
from transit.utils.tools import TrajBatchDisc
...
class TransitExpansionAgent(AgentrPPO):
    ...
    def setup_env(self):
        self.env = env = TransitEnv(self.cfg)
    ...
    def setup_model(self):
        cfg = self.cfg
        if cfg.agent == 'gagrl':
            self.policy_net, self.value_net = create_GAGRL_model(cfg, self)
